...
if  [ $FILE == "celeba-hq-dataset" ]; then
    ...
    mkdir -p ./expr/checkpoints_afhq
    CKPT_FILE='./expr/checkpoints_afhq/320001_nets_ema.ckpt'
    ...
    mkdir -p ./expr/checkpoints_celeba
    CKPT_FILE='./expr/checkpoints_celeba/320001_nets_ema.ckpt'
